 ...
 * @author ASUS
 */
public class AbsensiError extends javax.swing.JFrame {
    
    private static final java.util.logging.Logger logger = java.util.logging.Logger.getLogger(AbsensiError.class.getName());
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(() -> new AbsensiError().setVisible(true));
    }
