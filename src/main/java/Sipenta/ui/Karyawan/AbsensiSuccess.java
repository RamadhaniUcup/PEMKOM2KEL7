 ...
 */
package Sipenta.ui.Karyawan;

/**
 *
 * @author ASUS
 */
public class AbsensiSuccess extends javax.swing.JFrame {
    
    private static final java.util.logging.Logger logger = java.util.logging.Logger.getLogger(AbsensiSuccess.class.getName());

    /**
     * Creates new form AbsensiSuccess
     */
    public AbsensiSuccess() {
        initComponents();
    }
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(() -> new AbsensiSuccess().setVisible(true));
    }
